...
Layer = OFF
o_clkSlow = OUTPUT,36,3,-;
o_diodes_0_ = OUTPUT,9,0,-;
o_diodes_1_ = OUTPUT,8,0,-;
o_diodes_2_ = OUTPUT,7,0,-;
o_diodes_3_ = OUTPUT,6,0,-;
o_diodes_4_ = OUTPUT,5,0,-;
o_diodes_5_ = OUTPUT,4,0,-;
o_diodes_6_ = OUTPUT,3,0,-;
o_diodes_7_ = OUTPUT,2,0,-;
pres_counter_2_ = NODE,*,2,-;
pres_counter_1_ = NODE,*,2,-;
pres_counter_0_ = NODE,*,1,-;
pres_counter_3_ = NODE,*,3,-;
pres_counter_5_ = NODE,*,3,-;
pres_counter_6_ = NODE,*,1,-;
pres_counter_4_ = NODE,*,1,-;
currState_0_reg = NODE,*,2,-;
i_clk = INPUT,11,-,-;
